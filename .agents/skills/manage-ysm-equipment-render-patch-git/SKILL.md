...
```powershell
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation Inspect
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation Classify -Path <paths>
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation PropagateMain -Authorization ExplicitUser -ConfirmExecution
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation PrepareActiveWorktrees -MinecraftBranch <branches> -Path <main-paths> -Authorization ExplicitUser -ConfirmExecution
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation CaptureActiveWorktreeChanges -SnapshotPath <overlay-manifest>
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation MergeMain -SnapshotPath <capture-manifest> -Authorization ExplicitUser -ConfirmExecution
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation CleanupActiveWorktrees -Authorization ExplicitUser -ConfirmExecution
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation Validate
& .\.agents\skills\manage-ysm-equipment-render-patch-git\scripts\repository-workflow.ps1 -Operation Audit
```
